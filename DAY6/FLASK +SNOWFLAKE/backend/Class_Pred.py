...
# -----------------------------
devices = pd.read_csv("predictapp/backend/devicepreprocessed.csv", encoding="ISO-8859-1", low_memory=False)
manufacturers = pd.read_csv("predictapp/backend/manufacturer.csv", encoding="ISO-8859-1", low_memory=False)
events = pd.read_csv("predictapp/backend/final_preprocessed.csv", encoding="ISO-8859-1", low_memory=False)
